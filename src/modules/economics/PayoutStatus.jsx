// =============================================================================
// src/modules/economics/PayoutStatus.jsx
// Module 9 – Economics: Payment status tracker
// =============================================================================
...
const STATUSES = ['all', 'Scheduled', 'Paid', 'Overdue'];

// ── component ────────────────────────────────────────────────────────────────

export default function PayoutStatus({ payouts = [], onExport }) {
...
PayoutStatus.propTypes = {
  payouts: PropTypes.arrayOf(
    PropTypes.shape({
      ...
      status: PropTypes.oneOf(['Scheduled', 'Paid', 'Overdue']),
