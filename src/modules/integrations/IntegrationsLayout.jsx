...
const IntegrationsLayout = () => {
  ...
  const tabs = [
    ...
    { id: 'mapper', label: 'Field Mapper', icon: (
      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div className="h-full flex flex-col bg-gray-50">
      ...
      <div className="px-6 py-4 border-b border-gray-200 bg-white">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-[#02475A]">Integrations</h1>
            <p className="text-xs text-gray-500">API keys, system connections, field mappings, and webhooks</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-6">
        <IntegrationsPanel activeTab={activeTab} />
      </div>
    </div>
  );
};
